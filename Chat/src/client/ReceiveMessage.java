...
/**
 * Classe que È respons·vel por verificar se existem mensagens a serem recebidas
...
public class ReceiveMessage extends Thread {
	...
	/**
	 * MÈtoto que implementa o run() da thread para monitorizar a chegada de mensagens
	 */
	public void run(){
...
/**
 * Classe que È respons·vel por ler e guardar a mensagem recebida
 * @author Carolina e Manuel
 *
 */
class Handler extends Thread {
	...
	/**
	 * MÈtodo que implementa o run() da thread de forma ler as mensagens e guard·-las num ficheiro
	 */
	public void run() {
